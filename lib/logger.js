...
Logger.prototype.field = function (key, value) {
  ...
  try {
    ...
    // slim the space
    result = utils.slim(result);
    // dont send a big data
    if (result.length > maxlength) {
      result = '< LARGE DATA >' + result.slice(0, maxlength - 14);
    }
 ...
 * @return {Logger} this
 */
Logger.prototype.ip = function (ip) {
  return this.field('ip', ip);
};
/**
 * 设置日志内容: 请求主机
 * @host  host
 ...
 * @return {Logger} this
 */
Logger.prototype.host = function (host) {
  return this.field('host', host);
};
/**
 * 设置日志内容: 请求方法
 * @method  method
 ...
 * @return {Logger} this
 */
Logger.prototype.method = function (method) {
  return this.field('method', method);
};
/**
 * 设置日志内容: 请求路径
 * @method  path
 ...
 * @return {Logger} this
 */
Logger.prototype.body = function (body) {
  return this.field('body', body);
};
/**
 * 设置日志内容: 请求Query
 * @method  query
